...
## [12.3.1](https://github.com/heroku/heroku-cli-command/compare/command-v13.0.0-beta.3...command-v12.3.1) (2026-05-18)


### ⚠ BREAKING CHANGES

* avoid duplicate account prompt on logout ([#332](https://github.com/heroku/heroku-cli-command/issues/332))
* upgrade to oclif/core v4 ([#180](https://github.com/heroku/heroku-cli-command/issues/180))
